...
#
# Script generated by Vivado on Thu Dec 05 02:40:31 +0900 2024
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : buffer_ram_2.sh
...
#
# Usage        : buffer_ram_2.sh
#                buffer_ram_2.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                buffer_ram_2.sh [-reset_run]
#                buffer_ram_2.sh [-reset_log]
#                buffer_ram_2.sh [-help]
#
...
#                script (type 'buffer_ram_2.sh -help' for more information).
#
...
# script info
echo -e "buffer_ram_2.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./buffer_ram_2.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.buffer_ram_2 xil_defaultlib.glbl -o buffer_ram_2_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./buffer_ram_2_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key buffer_ram_2_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc buffer_ram_2_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./buffer_ram_2.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: buffer_ram_2.sh [-help]\n\
Usage: buffer_ram_2.sh [-step]\n\
Usage: buffer_ram_2.sh [-lib_map_path]\n\
Usage: buffer_ram_2.sh [-reset_run]\n\
Usage: buffer_ram_2.sh [-reset_log]\n\
Usage: buffer_ram_2.sh [-keep_index]\n\
Usage: buffer_ram_2.sh [-noclean_files]\n\n\
