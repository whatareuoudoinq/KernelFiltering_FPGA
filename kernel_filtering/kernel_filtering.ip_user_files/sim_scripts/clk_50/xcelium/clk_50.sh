...
#
# Script generated by Vivado on Thu Dec 05 02:34:16 +0900 2024
...
#
# Usage        : clk_50.sh
#                clk_50.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                clk_50.sh [-reset_run]
#                clk_50.sh [-reset_log]
#                clk_50.sh [-help]
#
...
#                script (type 'clk_50.sh -help' for more information).
#
...
# script info
echo -e "clk_50.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./clk_50.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.clk_50 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.clk_50 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log clk_50_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: clk_50.sh [-step]\n\
Usage: clk_50.sh [-lib_map_path]\n\
Usage: clk_50.sh [-reset_run]\n\
Usage: clk_50.sh [-reset_log]\n\
Usage: clk_50.sh [-keep_index]\n\
