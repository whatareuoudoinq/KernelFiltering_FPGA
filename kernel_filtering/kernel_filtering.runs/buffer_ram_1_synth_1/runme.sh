...
HD_PWD='C:/Users/LeeEunseo/Documents/GitHub/KernelFiltering_FPGA/kernel_filtering/kernel_filtering.runs/buffer_ram_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log buffer_ram_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source buffer_ram_1.tcl
