...
HD_PWD='C:/Users/boram/Desktop/kernel_filtering/kernel_filtering.runs/clk_25_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_25.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clk_25.tcl
